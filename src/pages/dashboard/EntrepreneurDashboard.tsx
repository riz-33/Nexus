...
const steps = [
  {
    ...
    content: "This is your main dashboard overview",
  },
  {
    target: "#cards-overview",
    content: "This is your main dashboard cards",
  },
  {
    target: "#nav-deals",
    content: "Track all your investment deals here",
  },
  {
    target: "#wallet-card",
    content: "Your wallet & funding activity",
  },
];
  ...
  return (
    <>
      ...
      <div className="space-y-6 animate-fade-in">
        <div id="nav-dashboard" className="flex justify-between items-center">
          <div>
        ...
        {/* Summary cards */}
        <div id="cards-overview" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
